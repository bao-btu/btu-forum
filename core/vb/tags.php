...
class vB_Tags
{
	...
	*/
	public function fetchTagLimits()
	{
		...
		$tagmaxtopic = $this->usercontext->getChannelLimits($this->nodeid, 'maxtags');
		return array('content_limit' => $tagmaxtopic, 'user_limit' => $user_limit);
	}
	...
	*/
	public function addTagsToContent($taglist)
	{
		...
		if (!empty($inserts))
		{
			...
			vB::getDbAssertor()->assertQuery('insertignoreValues', array('table' => 'tag', 'values' => $taglistInsert));
		}
