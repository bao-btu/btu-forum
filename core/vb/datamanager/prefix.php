...
* @date		$Date: 2010-09-28 19:58:46 -0300 (Tue, 28 Sep 2010) $
*/
class vB_DataManager_Prefix extends vB_DataManager
{
	...
	*/
	function vB_DataManager_Prefix(&$registry, $errtype = vB_DataManager_Constants::ERRTYPE_STANDARD)
	{
		parent::vB_DataManager($registry, $errtype);

		// Legacy Hook 'prefixdata_start' Removed //
	}
