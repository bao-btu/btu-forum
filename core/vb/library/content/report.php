			...
			if ($reportnode['starter'] == $reportnode['nodeid'])
			{
				$maildata = vB_Api::instanceInternal('phrase')->
					fetchEmailPhrases('reportpost_newthread', array(
						vB5_Route::buildUrl('profile|nosession|fullurl', array('userid' => $reporterInfo['userid'])), // reported profile link
						$reporterInfo['username'], // reported username
						$data['rawtext'], // reason
						vB5_Route::buildUrl($reportnode['routeid'] . '|nosession|fullurl', array('nodeid' => $reportnode['nodeid'], 'title' => $reportnode['title'])),
						$reportnode['title'],
						...
						vB5_Route::buildUrl('profile|nosession|fullurl', array('userid' => $reportnode['userid'])), // poster profile link
			...
			else
			{
				$maildata = vB_Api::instanceInternal('phrase')->
					fetchEmailPhrases('reportpost', array(
						...
						$reporterInfo['email'],
						$reportnode['title'],
						vB5_Route::buildUrl($reportnode['routeid'] . '|nosession|fullurl', 
							array(
						...
						vB5_Route::buildUrl($reportnode['routeid'] . '|nosession|fullurl', array('nodeid' => $reportnode['starter'], 'title' => $reportnode['startertitle'])),
						$data['rawtext'],
						),
