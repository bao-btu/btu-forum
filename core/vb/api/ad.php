...
class vB_Api_Ad extends vB_Api
{
	...
	/**
	 * Active status and display orders of multiple Ads
	 *  
	...
	/**
	 * [saveNumberOfHeaderAds description]
	 * 
	 * @param  [int] $number
	 * @return [bool]
	 */
...
//			),
	 ...
	 * 
	 * @param  [int] $adid   Ad ID
	 * @return [str] $output Display Options HTML
	 */
