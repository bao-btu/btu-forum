...
if ($_POST['do'] == 'emailpassword')
{
	...
	{
		print_stop_message2(fetch_error('invalidemail'));
	}
	...
	if (fetch_require_hvcheck('lostpw'))
	{
		...
		{
			print_stop_message2(fetch_error($verify->fetch_error()));
	  	}
	}

	try 
	{
		vB_Api::instance('user')->emailPassword(0, $vbulletin->GPC['email'], $vbulletin->GPC['humanverify']);
	}
	...
	print_cp_message(fetch_error('lostpw_gfrontredirect'), $vbulletin->url);
}
