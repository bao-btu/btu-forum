	...
	if (is_dir($styledir))
	{
		...
		if ($dirhandle) 
		{
			...
			while (($fname = readdir($dirhandle)) !== false)
			{
				...
				if (!is_dir($styledir . '/' . $fname)) 
				{
					@unlink($styledir . '/' . $fname);
				}
			}
			// Close the handle
			closedir($dirhandle);
...
function write_style_css_directory($styleid, $parentlist, $dir = 'ltr')
{
	...
	vB_Library::instance('Style')->setCssFileDate();
	$miscoptions = vB::getDatastore()->getValue('miscoptions');
	$cssfiledate = $miscoptions['cssfiledate'];
...
//	throw new Exception('old template syntax -- DO NOT WANT');
	...
	/* 
		we need to keep this list & the one in core\includes\template_tag_defs.php
		get_safe_functions() in sync. Eventually we'll want to have only 1 list...
	*/
...
function activateCodeMirror($ids)
{
	...
	?>
				<link rel="stylesheet" href="<?php echo $bburl?>/clientscript/codemirror/lib/codemirror.css?v=<?php echo SIMPLE_VERSION ?>">
				<link rel="stylesheet" href="<?php echo $bburl?>/clientscript/codemirror/addon/hint/show-hint.css?v=<?php echo SIMPLE_VERSION ?>">
				<script src="<?php echo $bburl?>/clientscript/codemirror/lib/codemirror.js?v=<?php echo SIMPLE_VERSION ?>"></script>

				<script src="<?php echo $bburl?>/clientscript/codemirror/mode/xml/xml.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/mode/javascript/javascript.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/mode/css/css.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<!-- <script src="<?php echo $bburl?>/clientscript/codemirror/mode/clike/clike.js?v=<?php echo SIMPLE_VERSION ?>"></script> -->
				<script src="<?php echo $bburl?>/clientscript/codemirror/mode/htmlmixed/htmlmixed.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/mode/vbulletin/vbulletin.js?v=<?php echo SIMPLE_VERSION ?>"></script>

				<script src="<?php echo $bburl?>/clientscript/codemirror/addon/mode/overlay.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/addon/selection/active-line.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/addon/edit/matchbrackets.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/addon/fold/foldcode.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/addon/search/match-highlighter.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/addon/edit/closetag.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/addon/hint/show-hint.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/addon/hint/vbulletin-hint.js?v=<?php echo SIMPLE_VERSION ?>"></script>
			<script type="text/javascript">
			<!--
...
function activateCodeMirrorPHP($ids)
{
	...
	?>
				...
				<script src="<?php echo $bburl?>/clientscript/codemirror/lib/codemirror.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/mode/clike/clike.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/mode/php/php.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				...
				<script src="<?php echo $bburl?>/clientscript/codemirror/addon/edit/closetag.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/addon/hint/show-hint.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="<?php echo $bburl?>/clientscript/codemirror/addon/hint/php-hint.js?v=<?php echo SIMPLE_VERSION ?>"></script>
			<script type="text/javascript">
			<!--
			window.onload = function() {
				$(["<?php echo implode('","', $ids)?>"]).each(function(){
