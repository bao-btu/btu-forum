...
function print_profilefield_row($basename, $profilefield, $userfield = '', $searching = true)
{
	...
	else if ($profilefield['type'] == 'select')
	{
		...
		if ($profilefield['optional'])
		{
			...
			$optionalfield = "<dfn>$vbphrase[other_please_specify_gprofilefield]:</dfn><input type=\"text\" name=\"$optionalname\" class=\"bginput\" value=\"$optional\" size=\"$profilefield[size]\" maxlength=\"$profilefield[maxlength]\" tabindex=\"1\" />";
		}
