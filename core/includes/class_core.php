...
define('FILE_VERSION', '5.0.3'); // this should match installsteps.php
if (!defined('SIMPLE_VERSION')) define('SIMPLE_VERSION', '503'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 75891 $
* @date		$Date: 2013-06-21 10:03:08 -0700 (Fri, 21 Jun 2013) $
*/
