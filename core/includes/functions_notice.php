...
function fetch_dismissed_notices()
{
	...
	if ($dismissed_notices === null)
	{
		...
		$noticeids = vB::getDbAssertor()->assertQuery('vBForum:fetchdismissednotices', array(
...
function fetch_relevant_notice_ids()
{
	...
	// Legacy Hook 'notices_check_start' Removed //
		...
		foreach ($notice AS $criteriaid => $conditions)
		{
			switch ($criteriaid)
			{
				...
				default:
				{
					...
					// Legacy Hook 'notices_check_criteria' Removed //
