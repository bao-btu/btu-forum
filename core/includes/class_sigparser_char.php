...
*
* @package 		vBulletin
* @version		$Revision: 69866 $
* @date 		$Date: 2012-12-26 18:36:47 -0800 (Wed, 26 Dec 2012) $
*
*/
class vB_SignatureParser_CharCount extends vB_SignatureParser
{
	...
	*/
	function vB_SignatureParser_CharCount(&$registry, $tag_list, $userid, $append_custom_tags = true)
	{
		parent::vB_SignatureParser($registry, $tag_list, $userid, $append_custom_tags);
