		...
		else
		{
			...
			foreach($infractionsInfo as $infractionInfo)
			{
				...
				$text[$infractionInfo['nodeid']] = sprintf(
					...
					vB5_Route::buildUrl($infractionInfo['routeid'] . '|nosession|fullurl', array('nodeid' => $infractionInfo['infractednodeid'], 'title' => $infractionInfo['title']), array('p' => $infractionInfo['infractednodeid'])) . '#post' . $infractionInfo['infractednodeid'],
					// infracted topic title
					$infractionInfo['title'],
					// infracted user link
					vB5_Route::buildUrl('profile|nosession|fullurl', array('userid' => $infractionInfo['iuserid'])),
					// infracted user name
