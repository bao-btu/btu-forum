...
define('CVS_REVISION', '$RCSfile$ - $Revision: 71673 $');
...
function print_channels($permissions, $inheritance = array(), $channels = false, $indent = '	')
{
	...
	if ($channels === false)
	{
		$channels = vB_Api::instanceInternal('search')->getChannels(false, array('include_protected' => true));
	}
