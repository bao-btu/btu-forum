...
define('CVS_REVISION', '$RCSfile$ - $Revision: 71511 $');
	...
	else
	{
		...
		$assertor->assertQuery('vBForum:moderator', array(
		   ...
		   vB_dB_Query::CONDITIONS_KEY => array(
		      array('field' => 'userid', 'value' => $vbulletin->GPC['userid'], 'operator' =>  vB_dB_Query::OPERATOR_EQ),
		      array('field' => 'nodeid', 'value' => 0, 'operator' =>  vB_dB_Query::OPERATOR_GT),
		   )
		));
