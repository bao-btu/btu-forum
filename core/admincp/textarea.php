...
define('CVS_REVISION', '$RCSfile$ - $Revision: 54087 $');
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $vbulletin->options['bburl']?>/cpstyles/<?php echo $vbulletin->options['cpstylefolder']; ?>/controlpanel.css" />
	...
	<script type="text/javascript" src="<?php echo $vbulletin->options['bburl']?>/clientscript/yui/connection/connection-min.js?v=<?php echo SIMPLE_VERSION; ?>"></script>
	<script type="text/javascript" src="<?php echo $vbulletin->options['bburl']?>/clientscript/vbulletin_global.js?v=<?php echo SIMPLE_VERSION; ?>"></script>
