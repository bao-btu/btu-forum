...
if ($_POST['do'] == 'saveforum')
{
	...
	print_stop_message2('saved_content_priority_successfully', 'sitemap', array('do'=>'forum'));
}
...
if ($_POST['do'] == 'saveblog')
{
	...
	{
		print_stop_message2('saved_content_priority_successfully', 'sitemap', array('do' => 'blog'));
	}
}
...
if ($_POST['do'] == 'savecms')
{
	...
	print_stop_message2('saved_content_priority_successfully', 'sitemap', array('do'=>'cms'));
}
