...
define('CVS_REVISION', '$RCSfile$ - $Revision: 73828 $');
...
$queryoptions = array(
	...
	$vbphrase['all_users'] => array(
		...
		'20'  => $vbphrase['yes'] . ' - ' . $vbphrase['allow_vcard_download_gsql'],
		'90'  => $vbphrase['no'] . ' - ' . $vbphrase['allow_vcard_download_gsql'],

		'30'  => $vbphrase['yes'] . ' - ' . $vbphrase['receive_admin_emails_gsql'],
		'100' => $vbphrase['no'] . ' - ' . $vbphrase['receive_admin_emails_gsql'],

		'40'  => $vbphrase['yes'] . ' - ' . $vbphrase['display_email_gsql'],
		'110' => $vbphrase['no'] . ' - ' . $vbphrase['display_email_gsql'],
		...
		'260' => $vbphrase['posts'] . ' - ' . $vbphrase['oldest_first_gsql'],
		'265' => $vbphrase['posts'] . ' - ' . $vbphrase['newest_first_gsql'],
	...
	$vbphrase['all_forums'] => array(
		...
		'420' => $vbphrase['show_all_threads_guser'],
	),
);
...
if ($_REQUEST['do'] == 'modify')
{
	...
	<script src="<?php echo $bburl?>/clientscript/codemirror/mode/sql/sql.js?v=<?php echo SIMPLE_VERSION ?>"></script>
