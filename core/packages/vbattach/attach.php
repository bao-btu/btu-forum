...
*
* @package 		vBulletin
* @version		$Revision: 59531 $
* @date 		$Date: 2012-02-23 13:19:56 -0700 (Thu, 23 Feb 2012) $
*
*/
...
abstract class vB_Attachment_Store
{
	...
	*/
	...
	public function delete($ids)
	{
		if (!empty($ids))
		{
			$attachdata =& datamanager_init('Attachment', $this->registry, vB_DataManager_Constants::ERRTYPE_STANDARD, 'attachment');
	...
	protected function &fetch_attachdm()
	{
		...
		$attachdata =& datamanager_init('AttachmentFiledata', $this->registry, vB_DataManager_Constants::ERRTYPE_ARRAY, 'attachment');
